                      ...
                      SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const Text("Terms and Conditions",style: TextStyle(fontSize: 18,color: Colors.white,fontWeight: FontWeight.bold),),
                            const SizedBox(
                              width: 60,
                            )
                          ],
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 20,),
                        Text("   This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://myhr.einlogica.com (\'Website\'), including the related mobile site and mobile application (hereinafter referred to as \'Platform\')."),
                        SizedBox(height: 20,),
                        Text("   The Platform is owned by EINLOGICA SOLUTIONS PRIVATE LIMITED, a company incorporated under the Companies Act, 1956 with its registered office at Muttath House, AJN 9, Ernakulam, India (hereinafter referred to as ‘Platform Owner’, \'we\', \'us\', \'our\'). Your use of the Platform and services and tools are governed by the following terms and conditions (“Terms of Use”) as applicable to the Platform including the applicable policies which are incorporated herein by way of reference. If You transact on the Platform, You shall be subject to the policies that are applicable to the Platform for such transaction. By mere use of the Platform, You shall be contracting with the Platform Owner and these terms and conditions including the policies constitute Your binding obligations, with Platform Owner. These Terms of Use relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, \'Services\'). Any terms and conditions proposed by You which are in addition to or which conflict with these Terms of Use are expressly rejected by the Platform Owner and shall be of no force or effect. These Terms of Use can be modified at any time without assigning any reason. It is your responsibility to periodically review these Terms of Use to stay informed of updates."),
                        SizedBox(height: 20,),
                        ...
                        SizedBox(height: 20,),
                        Text("The use of Platform and/or availing of our Services is subject to the following Terms of Use:"),
                        SizedBox(height: 20,),
                        ...
                        SizedBox(height: 10,),
                        Text("*    All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Ernakulam, Kerala."),
                        SizedBox(height: 10,),
