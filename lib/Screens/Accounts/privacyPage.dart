                      ...
                      SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const Text("Privacy Policy",style: TextStyle(fontSize: 18,color: Colors.white,fontWeight: FontWeight.bold),),
                            const SizedBox(
                              width: 60,
                            )
                          ],
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 20,),
                        Text("Sharing", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
                        ...
                        SizedBox(height: 20,),
                        Text("Security Precautions", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
                        ...
                        SizedBox(height: 20,),
                        Text("Data Deletion and Retention", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
                        ...
                        SizedBox(height: 20,),
                        Text("Your Rights", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
                        Text("    You may access, rectify, and update your personal data directly through the functionalities provided on the Platform."),
                        SizedBox(height: 20,),
                        Text("Consent", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
                        ...
                        SizedBox(height: 20,),
                        Text("Changes to this Privacy Policy", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
                        ...
                        Text("    Sasimon M S"),
                        Text("    Einlogica Solutions Private Limited,"),
                        Text("    Muttath House, AJN-9, Angamaly"),
                        SizedBox(height: 20,),
